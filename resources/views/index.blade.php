				...
				<div  class="slick-multiItemSlider">
					...
					<div class="movie-item">
						...
						<div class="title-in">
							...
							<h6><a href="/movie_details/{{$f->id}}">{{$f->title}}</a></h6>
		...
		<div class="container centered">
			<div class="row ipad-width">
					<div class="title-hd">
						...
						<h2>Best Movies</h2>
						<a href="/movies_all" class="viewall">View all <i class="ion-ios-arrow-right"></i></a>
					</div>
					<div class="tabs">
								...
								<div class="row">
                                    ...
                                    ?>
										...
										<div class="slide-it">
											<div class="movie-item">
												<div class="mv-img">
                                                                                                    <img src="{{$f->small_pic}}" style="width: 265px; height: 200px">
												</div> 
												<div class="hvr-inner">
